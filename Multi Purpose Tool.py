...
'''))
    ...
    # Token Checker
        ...
        if __name__ == "__main__":
            ctypes.windll.kernel32.SetConsoleTitleW("Discord Token Checker | Made by GuFFy_OwO")
        ...
        if "1" in checkType:
            print()
            tokenFileName = input(f"{Fore.CYAN}>{Fore.RESET}Enter the directory location where your unchecked tokens are in{Fore.CYAN}:{Fore.RESET} ")
            checkName = os.path.splitext(os.path.basename(tokenFileName))[0]
        elif "2" in checkType:
            print()
            tokenDirectoryName = input(f"{Fore.CYAN}>{Fore.RESET}Enter the directory location where your unchecked tokens are in{Fore.CYAN}:{Fore.RESET} ")
            ...
            if "1" in ckeckFilesType:
                ...
                print()
                fileTypes = ["." + x for x in input(f"{Fore.CYAN}>{Fore.RESET}Enter file types in which the unchecked tokens are separated by space [txt json html ...]{Fore.CYAN}:{Fore.RESET} ").split()]
            else:
                print()
                print("Invalid Option.")
                fexit()
        ...
        print()
        checkTokens = input(f"{Fore.CYAN}>{Fore.RESET}Check validity of tokens? [Y/N]{Fore.CYAN}:{Fore.RESET} ")
...
license = ["Aran","Aran1","OptiTokens","Airan","Tokens","Access","LetUserIn","Beginner","Github","Working","Discord","Generator","14","FirstProject","Commit"]
